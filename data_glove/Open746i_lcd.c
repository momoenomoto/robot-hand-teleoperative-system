/**
  ...
  ******************************************************************************
  ...
  --------------------------
     ...
     - This driver uses timing and setting for Waveshare LCD.
...
{    
  ...
  /* The Waveshare LCD 1024x600 is selected */
  /* Timing Configuration */
  hLtdcHandler.Init.HorizontalSync = 19;
  hLtdcHandler.Init.VerticalSync = 2;
  hLtdcHandler.Init.AccumulatedHBP = 159;
  hLtdcHandler.Init.AccumulatedVBP = 22;
  hLtdcHandler.Init.AccumulatedActiveH = 622;
  hLtdcHandler.Init.AccumulatedActiveW = 1183;
  hLtdcHandler.Init.TotalHeigh = 634;
  hLtdcHandler.Init.TotalWidth = 1343;
  
  /* LCD clock configuration */
  BSP_LCD_ClockConfig(&hLtdcHandler, NULL);

  /* Initialize the LCD pixel width and pixel height */
  hLtdcHandler.LayerCfg->ImageWidth  = 1024;
  hLtdcHandler.LayerCfg->ImageHeight = 600;
  ...
  /* Initialize layers */
  BSP_LCD_LayerRgb565Init(0, 0xD0000000);
	//__HAL_LTDC_LAYER_ENABLE(&hLtdcHandler, 0);
  BSP_LCD_LayerRgb565Init(1, 0xD0200000);
...
__weak void BSP_LCD_MspInit(LTDC_HandleTypeDef *hltdc, void *Params)
{
  ...
  /* GPIOI configuration */
  gpio_init_structure.Pin       = GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_0|GPIO_PIN_1 
...
__weak void BSP_LCD_ClockConfig(LTDC_HandleTypeDef *hltdc, void *Params)
{
  ...
  /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN = 128 Mhz */
  /* PLLLCDCLK = PLLSAI_VCO Output/PLLSAIR = 128/2 = 64 Mhz */
  /* LTDC clock frequency = PLLLCDCLK / LTDC_PLLSAI_DIVR_2 = 64/2 = 32 Mhz */
  periph_clk_init_struct.PeriphClockSelection = RCC_PERIPHCLK_LTDC;
  periph_clk_init_struct.PLLSAI.PLLSAIN = 128;
