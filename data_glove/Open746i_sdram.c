/**
  ******************************************************************************
  * @file    Open746i_sdram.c
  * @author  Romain Corcolle
  * @brief   This file includes the SDRAM driver for the IS42S16400J memory 
  *          device mounted on Open746i board.
  *
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  @verbatim
   ...
   --------------------------
      - This driver is used to drive the IS42S16400J SDRAM external memory mounted
        on Open746i board.
